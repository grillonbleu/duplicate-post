...
function duplicate_post_wpml_init() {
	if ( defined( 'ICL_SITEPRESS_VERSION' ) ) {
		add_action( 'duplicate_post_page_duplicated', 'duplicate_post_wpml_copy_translations', 10, 3 );
		add_action( 'duplicate_post_post_duplicated', 'duplicate_post_wpml_copy_translations', 10, 3 );
...
function duplicate_post_wpml_copy_translations( $post_id, $post, $status = '' ) {
	...
	remove_action( 'duplicate_post_page_duplicated', 'duplicate_post_wpml_copy_translations', 10 );
	remove_action( 'duplicate_post_post_duplicated', 'duplicate_post_wpml_copy_translations', 10 );
